...
import GbysFormV3 from '@/components/design-options/v3/programs/GbysFormV3'
import type { getGbysPageContent } from '@/lib/keystatic/pages'

interface GbysV3Props {
...
export default function GbysV3({ gbys }: GbysV3Props) {
    ...
    return (
        <main className="bg-white text-hvblue">
            {/* ============================================================ */}
            {/* HERO — full-bleed hvblue, big headline, GBYS logo */}
            {/* ============================================================ */}
            ...
            {/* ============================================================ */}
            {/* SERVICES — bento grid on slate-50 */}
            {/* ============================================================ */}
            ...
            {/* ============================================================ */}
            {/* FORM — white band, bold tabbed form */}
            {/* ============================================================ */}
