...
- Use Keystatic local-file storage during development.
- Use Keystatic Cloud project `al-hands-and-voices/al-hands-and-voices` for authenticated production editing.
...
- Homepage and migrated content pages read from Git-backed Keystatic content files, not Firestore.
- Keystatic admin opens locally and through Keystatic Cloud at `/keystatic`.
...
- [x] Select Keystatic Cloud for production while retaining local-file development.
...
- [x] Keystatic admin still loads.
- [x] Public pages still render.
...
- [x] `npm run lint`
- [x] `npx tsc --noEmit`
- [x] Playwright route, CMS, accessibility, and SEO regression coverage
- [x] Chromium, Firefox, WebKit, and mobile Chromium project matrix
- [x] WCAG 2.2 A/AA Axe checks on desktop and mobile Chromium
...
- [x] Footer links work.
- [x] Homepage renders Keystatic content.
- [x] About, Board, Staff, Contact pages render.
- [x] FAQ accordion works.
- [x] Resources and program pages render.
- [x] DHH and Resources video galleries work.
- [x] Membership pages render with protected prices and payment IDs.
- [x] Netlify forms render with accessible labels and keyboard order.
- [x] Keystatic admin opens.
- [x] Production-like build reads Keystatic content from `src/content`.
- [x] Form submission and privacy testing remain outside this phase.

### Deployment Readiness

- [x] Update README with local-file development and Cloud production workflows.
- [x] Add a staff-facing Keystatic editor guide.
- [x] Update deployment and production verification notes for Netlify.
- [x] Document Keystatic Cloud project and authentication workflow.
- [x] Confirm deployment packaging includes `src/content/**/*`.
- [x] Document protected CMS behavior and accessibility findings.
- [x] Confirm no Firebase environment variables remain.

Acceptance criteria:

- [x] All core routes pass automated smoke testing.
- [ ] Final full Playwright matrix passes after the QA changes.
- [x] Build, lint, and TypeScript checks pass.
- [x] Keystatic local development and Cloud production modes are documented.
- [x] Migration notes are current.
...
- [ ] Performance and responsive-image audit with Core Web Vitals budgets.
- [ ] Visual regression baselines.
- [ ] Real-time Keystatic previews with secure branch and token handling.
...
| 2026-06-14 | Keystatic release | Restored the current App Router Keystatic UI, selected Cloud production storage, protected routing/payment values, connected global settings and videos, and verified the production Netlify editor surface. | Codex |
| 2026-06-14 | QA and accessibility | Added Playwright projects for Chromium, Firefox, WebKit, and mobile Chromium; added WCAG 2.2 A/AA Axe checks; corrected public landmarks, headings, contrast, list semantics, keyboard tabs, focus visibility, form announcements, and reduced motion. | Codex |
| 2026-06-14 | SEO and resilience | Added fixed route metadata, canonical/Open Graph/Twitter fields, a generated social image, sitemap, robots rules, nonprofit Organization JSON-LD, and branded loading/error/not-found states. | Codex |
| 2026-06-14 | Documentation | Updated developer setup, Cloud production workflow, Netlify verification, protected CMS behavior, staff editing instructions, and accessibility findings. | Codex |
